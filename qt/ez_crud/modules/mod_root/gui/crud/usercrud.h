...
#ifndef CRUD_USERCRUD_H
#define CRUD_USERCRUD_H
...
class EZCRUD_EXPORT UserCrud : public BaseCRUD
{
    Q_OBJECT
public:
    UserCrud(crud::EasyCrud::CRUDFlags &crudFlags, QWidget *parent = 0);
...
private:
    QList<crud::Module *> m_moduleList;

};

} // namespace crud

#endif // CRUD_USERCRUD_H
