/* 
   Função que informa os dígitos verificadores de um CPF.
   Para utilizar, basta incluir a biblioteca: <DigCPF.h>
   E chamar por: DigCPF();
...
// Informa o Numero completo do CPF
       if (erro==0)
       {
       cout << "\n\nO numero completo do CPF e:\n\n";
