...
CREATE  TABLE IF NOT EXISTS `persona_categoria` (
  ...
  INDEX `fk_persona_has_categoria_categoria1` (`idcategoria` ASC) ,
  INDEX `fk_persona_has_categoria_persona1` (`idpersona` ASC) ,
  CONSTRAINT `fk_persona_has_categoria_persona1`
    FOREIGN KEY (`idpersona` )
    REFERENCES `industryhacks`.`persona` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_persona_has_categoria_categoria1`
    FOREIGN KEY (`idcategoria` )
    REFERENCES `industryhacks`.`categoria` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
