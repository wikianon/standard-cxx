...
+------------------------------------------------------------------------------+
*/
#include "interface_filechooserdialogDiretorio.h"
...
{
	//ajustes final
	_be_Interfaces_filechooserdialogDiretorio_ajustes_finais (mae);
...
GtkWidget *be_Interface_criar_filechooserdialogDiretorio_dialog_action_area1 (GtkWidget *janela, GtkAccelGroup *accel, GtkTooltips *tip, gpointer Data, GtkWidget *mae)
{
	...
	//filhas
	be_Interface_criar_filechooserdialogDiretorio_button1 (janela, accel, tip, Data, NULL);//chamada especial
	be_Interface_criar_filechooserdialogDiretorio_button2 (janela, accel, tip, Data, NULL);//chamada especial
	filha = NULL;
