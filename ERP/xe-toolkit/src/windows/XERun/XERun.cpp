...
// XERun.cpp : Defines the entry point for the console application.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
    ...
    classpath += cp;
    _snprintf_s(cp, sizeof cp, sizeof cp, ";%s\\jars\\forms-1.0.7.jar", top);
    classpath += cp;
    _snprintf_s(cp, sizeof cp, sizeof cp, ";%s\\jars\\looks-2.0.4.jar", top);
    classpath += cp;
