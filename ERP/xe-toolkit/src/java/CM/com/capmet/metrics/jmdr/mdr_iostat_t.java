...
/**
 * The mdr_iostat_t class provides data about the iostats in the operating
 ...
 * @version 1.0
 */
public class mdr_iostat_t extends mdr_t implements mdr_tuple_t
{
    ...
    public static final int MD_FIELD_COUNT      = 14;

    /**
     * Call the constructor for the C++ class
     */
    private native boolean iostat_constructor(String remote_host);
    
    /**
     * Call the refresh method in the C++ class
     */
    private native boolean iostat_refresh();
    
    /**
     * mdr_iostat_t constructor for localhost.
     * @throws mdr_exception_t Thrown from JNI code
     */
    public mdr_iostat_t() throws mdr_exception_t
    {
        if (!iostat_constructor(null))
            throw new mdr_exception_t(reason);
    }
    
    /**
     * mdr_iostat_t constructor for remote hosts.
     * @param remote_host The name of the remote host.
     * @throws mdr_exception_t Thrown from JNI code
     */
    public mdr_iostat_t(String remote_host) throws mdr_exception_t
    {
        if (!iostat_constructor(remote_host))
            throw new mdr_exception_t(reason);
    }
        ...
        throws mdr_exception_t
    {
        ...
        if (!mdr_get_field(key, can, field_number))
            throw new mdr_exception_t("mdr_iostat_t::mdr_field_value: " +
